...
function changeText(id) {
  let diff = 0
  let div = 0;
  let sem1p1 = document.getElementById("Se Sem 1 Period 1").value;
  let sem1p2 = document.getElementById("Se Sem 1 Period 2").value;
  let sem1p3 = document.getElementById("Se Sem 1 Period 3").value;
  let sem1p4 = document.getElementById("Se Sem 1 Period 4").value;
  let sem2p1 = document.getElementById("Se Sem 2 Period 1").value;
  let sem2p2 = document.getElementById("Se Sem 2 Period 2").value;
  let sem2p3 = document.getElementById("Se Sem 2 Period 3").value;
  let sem2p4 = document.getElementById("Se Sem 2 Period 4").value;
