...
function changeText(id) {
  ...
  let sem1p2 = document.getElementById("Sem1P2").value;
  let sem1p3 = document.getElementById("Sem1P3").value;
  let sem1p4 = document.getElementById("Sem1P4").value;
  let sem2p1 = document.getElementById("Sem2P1").value;
  let sem2p2 = document.getElementById("Sem2P2").value;
  let sem2p3 = document.getElementById("Sem2P3").value;
  let sem2p4 = document.getElementById("Sem2P4").value;
